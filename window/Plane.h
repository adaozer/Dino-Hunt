...
public:
	...
	void init(Core* core) {
		...
		vertices.push_back(addVertex(Vec3(-60, 0, -60), Vec3(0, 1, 0), 0, 0));
		vertices.push_back(addVertex(Vec3(60, 0, -60), Vec3(0, 1, 0), 1, 0));
		vertices.push_back(addVertex(Vec3(-60, 0, 60), Vec3(0, 1, 0), 0, 1));
		vertices.push_back(addVertex(Vec3(60, 0, 60), Vec3(0, 1, 0), 1, 1));
